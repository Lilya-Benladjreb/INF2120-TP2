 ...
 * 
 * <p><b>Notez</b> que lorsqu'un des services doit rechercher un element dans 
 * cette liste, il est possible que ce soit la methode 
 * <i>public boolean equals (Object o)</i> 
 ...
 * 
 * <li>Puisque cette liste est triee, les elements (de type T) dans cette liste 
 * doivent implementer l'interface Comparable pour assurer la redefinition de la 
 ...
 * l'emplacement d'un des elements de la liste 
 * (lorsque celle-ci n'est pas vide).</li>
 * 
 ...
 * 
 * <li>Dans une liste d'un seul element, la position courante pointe sur cet 
 * element.</li>
 * </ul>
 * 
 ...
 * de la liste. La methode <i>positionner(T elem)</i> permet de placer la position 
 * courante sur l'element donne, s'il existe dans la liste. Ensuite, des services 
 * comme <i>precedent</i> et <i>suivant</i> permettent de deplacer la position 
 * courante vers le debut, ou vers la fin de la liste. En utilisant la methode 
